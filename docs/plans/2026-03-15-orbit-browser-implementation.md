  ...
  <div id="app">
    ...
    <div class="new-tab-page" id="newTabPage">
      ...
      <div class="shortcuts-row">
        ...
        <button class="shortcut-btn" data-url="https://github.com/nodaysidle" data-label="GitHub">
          ...
          <span class="shortcut-tooltip">github.com/nodaysidle</span>
        </button>
...
.traffic.maximize { background: #C8FF00; }
