...
impl Default for BrowserState {
    fn default() -> Self {
        Self {
            tabs: Mutex::default(),
            tab_order: Mutex::default(),
            active_tab: Mutex::default(),
            window_size: Mutex::default(),
            overlay_height: Mutex::default(),
...
/// Acquire a lock on BrowserState data. Callers holding multiple locks
/// must always acquire in canonical order: tabs -> tab_order -> active_tab
